...
def obj(x):
    ...
    if mu>=1 or nu>=1 or mu<0 or nu<0: return 9.
    if (a-b)*(c-d)>0: return 9.        # sign flip: proved at maximizers
    return -gap
...
print(f"sweep: {n} configs with mu,nu in [0,1) AND opposite skews")
